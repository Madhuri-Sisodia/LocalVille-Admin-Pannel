...
import { useHistory } from "react-router-dom";
import { Form, Button, Panel, Loader, InputGroup } from "rsuite";
import "../../assets/css/login.css";
import LoginNavbar from "components/Navbars/LoginNavbar";
...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (validate()) {
      // Simulate a login without API
      setBtnloading(true);

      const hardcodedEmail = "madhurisisodia@gmail.com";
      const hardcodedPassword = "madhuri123";
